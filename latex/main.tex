...
\begin{par}
	...
	quelques details en fin du stage mais j'ai chop\'e
...
\begin{par}
	Github nous offre une page de wikis pour le projet
	et cela nous permet d'ecrire une documentation a la
	mesure pour le projet. Dans cette section j'ai 
...
\begin{par}
	Le projet a eu un developement lent due ma manque
	d'experience mais en general j'ai bien ger\'e le temp.
...
\begin{par}
	...
	stage et je n'ai pas pu finir quelques choses au
	FabLab parce que j'ai du me confiner. Ces jours de
...
\begin{par}
	La raspberry comme dock multiplataforme est 
	l'avancement le plus remarquable de mon stage. Elle
	a une base de donn\'ees complete avec l'imformation
...
\end{par}
\begin{par}
	Toute l'information capt\'e par la 
\end{par}
